...
export default function WhatsAppButton({ propertyTitle }: WhatsAppButtonProps) {
  ...
  const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '543447497062';
  const defaultMessage = propertyTitle
    ? `Hola Andrea, me interesa la propiedad: *${propertyTitle}*. ¿Podría darme más información?`
    : `Hola Andrea, me gustaría consultar sobre sus propiedades disponibles.`;
